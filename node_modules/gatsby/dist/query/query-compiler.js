...
const determineUsedFragmentsForDefinition = (definition, definitionsByName, fragmentsUsedByFragment, visitedFragments = new Set()) => {
  const {
    def,
    name,
    isFragment,
    ...
    visit(def, {
      [Kind.FRAGMENT_SPREAD]: node => {
        ...
        if (fragmentDefinition) {
          ...
          } = determineUsedFragmentsForDefinition(fragmentDefinition, definitionsByName, fragmentsUsedByFragment, visitedFragments);
